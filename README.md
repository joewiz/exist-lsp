...
A Java extension module that exposes eXist-db's XQuery compiler internals as XQuery functions, enabling LSP servers and editors to provide diagnostics, symbol information, completions, hover, go-to-definition, and find-all-references for XQuery code.

## Requirements

- [eXist-db](https://exist-db.org) version `6.0.0` or greater
...
1. Download the `exist-lsp-1.0.0.xar` file from the GitHub [releases](https://github.com/joewiz/exist-lsp/releases) page.
...
```bash
xst package install exist-lsp-1.0.0.xar
```
...
The XAR package will be at `target/exist-lsp-1.0.0.xar`.
...
[release-url]: https://github.com/joewiz/exist-lsp/releases/latest
